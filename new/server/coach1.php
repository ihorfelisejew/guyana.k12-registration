...
//	$is_student = $data['is_student'];
	...
	echo $fsdfdfsdfs = "INSERT INTO invoice (Org_Name, `registrations_fee`, `date`, `student`,`org_email`)
			VALUES ('$Org_name','$registrations_fee', '$getcurrdate','$no_students', '$email_name'  )";
