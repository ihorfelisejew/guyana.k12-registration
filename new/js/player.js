...
function getPlayers(){
	...
	for(var i in meta.teammate){
		
			
		
		html+="<tr>"
			html+="<td>"+meta.teammate[i].name+"</td>"
			html+="<td>"+meta.teammate[i].last_name+"</td>"
			html+="<td>"+meta.teammate[i].teamname+"</td>"
			html+="<td>"+meta.teammate[i].org_name+"</td>"
		html+="</tr>"
	}
